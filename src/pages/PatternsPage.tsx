...
import { GuidesLibraryView } from '../components/guides/GuidesLibraryView'
...
type LibraryView = 'patterns' | 'guides'
...
export function PatternsPage() {
  ...
  return (
    <div className={styles.page}>
      ...
      <div className={styles.viewSwitch} role="tablist" aria-label="Bibliothèque">
        <button type="button" role="tab" aria-selected={view === 'patterns'} className={view === 'patterns' ? styles.viewTabActive : styles.viewTab} onClick={() => setView('patterns')}>
          Patrons
        </button>
        <button type="button" role="tab" aria-selected={view === 'guides'} className={view === 'guides' ? styles.viewTabActive : styles.viewTab} onClick={() => setView('guides')}>
          Guides
        </button>
      </div>
